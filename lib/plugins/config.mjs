...
export default fastifyPlugin(async (fastify) => {
	const schema = {
		...
		properties: {
			...
			THB_FIRST_ACCOUNT_PARENT: {type: 'string', minLength: 1},
			THB_CAPITALIZE_ACCOUNT: {type: 'boolean', default: false}
		},
	...
	fastify.config = {
		...
		firstAccountParent: config.THB_FIRST_ACCOUNT_PARENT,
		capitalizeAccount: config.THB_CAPITALIZE_ACCOUNT
	};
});
